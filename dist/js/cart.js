...
document.addEventListener('DOMContentLoaded', function () {
  ...
  if (payBtn) {
    payBtn.addEventListener("click", function () {
      var lineItems = JSON.parse(localStorage.getItem("cartItems")); // get items from local storage
    ...
    checkoutButton.addEventListener('click', /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
      ...
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            lineItems = getLineItemsFromCart(); // replace with your actual function to get line items from cart
            _context.next = 3;
